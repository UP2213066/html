...
$preparedSQL = $connection->prepare("INSERT INTO staff(email, name, role, password, quota, allocatedStudents, studentsToAvoid) VALUES(?, ?, ?, ?, ?, 0, NULL) ON DUPLICATE KEY UPDATE quota=VALUES(quota), allocatedStudents=VALUES(allocatedStudents), studentsToAvoid=VALUES(studentsToAvoid)");
